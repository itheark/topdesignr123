...
<h1><img class="mainlogo" src="<?php echo base_url();?>/images/logo.png" alt="logo"></h1></a>
       <div class="container">
        ...
        <?php echo form_open_multipart('main/submission');?> 
        <div class="form-group ">
                                        
            <label for="remember">Add Image File as .JPEG .JPG or .PNG. Select Multiple Files at Once.</label>
            </div>
        <div class="form-group">
        <?php echo "<input type='file' name='userFiles[]' size='20' id='file' multiple/>"; ?>
    </div>
        <div class="form-group">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
        <?php echo "<input type='submit' name='filesubmit' value='Submit' class='form-control btn btn-login'/> ";?>
                </div>
            </div>
         </div>
