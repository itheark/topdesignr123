							...
							<div class="col-lg-12">
								...
								<form id="register-form" action="" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="c_title" id="username" tabindex="1" class="form-control" placeholder="Competition Title" value="<?php echo set_value('c_title');?>">
									</div>
                                    <div class="form-group">
                                        <input type="text" name="c_des" id="username" tabindex="1" class="form-control" placeholder="Add a description" value="<?php echo set_value('c_des');?>">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="c_host" id="username" tabindex="1" class="form-control" placeholder="Competition Conducted by.." value="<?php echo set_value('c_title');?>">
                                    </div>
