...
<html lang="en">
  ...
  <body>
    ...
    <div id="copyright">
        ...
        <div id="web_by"><img src="<?php echo base_url();?>/assets/img/steinlinconsulting.png" />     <img id="jobotic" src="<?php echo base_url();?>/assets/img/jobotic.png"> <label> Visit us!</label> </div>
    </div>
    ...
    <script src="<?php echo base_url();?>/assets/croppic.min.js"></script>
